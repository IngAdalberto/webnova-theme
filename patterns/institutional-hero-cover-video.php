<?php
/**
 * Title: WebNova Institucional - Hero video de fondo
 * Slug: webnova/institutional-hero-cover-video
 * Categories: webnova-institucional
 * Description: Hero con video de fondo local y superposición para instituciones.
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/assets/videos/placeholder-hero.mp4' ); ?>","backgroundType":"video","dimRatio":70,"overlayColor":"primary-dark","isUserOverlayColor":true,"align":"full","className":"webnova-institutional-hero webnova-institutional-hero--video has-transparent-header"} -->
<div class="wp-block-cover alignfull webnova-institutional-hero webnova-institutional-hero--video has-transparent-header"><span aria-hidden="true" class="wp-block-cover__background has-primary-dark-background-color has-background-dim-70 has-background-dim"></span><video class="wp-block-cover__video-background intrinsic-ignore" autoplay muted loop playsinline src="<?php echo esc_url( get_template_directory_uri() . '/assets/videos/placeholder-hero.mp4' ); ?>" poster="<?php echo esc_url( get_template_directory_uri() . '/assets/images/placeholders/institutional-hero-bg.jpg' ); ?>" data-object-fit="cover"></video><div class="wp-block-cover__inner-container">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column webnova-institutional-hero__content" style="flex-basis:60%">
            ...
            <p class="webnova-institutional-hero__description has-background-color has-text-color has-lg-font-size"><?php esc_html_e( 'Impulsamos programas y proyectos que fortalecen capacidades y generan cambios sostenibles en las comunidades.', 'webnova-starter-kit' ); ?></p>
            <!-- /wp:paragraph -->
